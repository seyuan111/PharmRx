...
const Login = () => {
  return (
    <div className="w-full min-h-screen flex flex-col">
      <NavBar />
      <div className="m-8 mt-14 relative flex-1 flex items-center justify-center px-4 py-10 sm:px-6 lg:px-8">
        {/* Login Form Container */}
        <div className="bg-neutral-500/20 border border-white/50 backdrop-blur-lg shadow-xl rounded-xl p-8 w-full max-w-md animate-fade-in">
