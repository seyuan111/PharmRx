  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <div className="flex justify-center items-center min-h-screen px-4">
        <div className="mt-20 w-full max-w-5xl bg-white shadow-xl rounded-xl overflow-hidden flex flex-col md:flex-row animate-fade-in">
          ...
          <div className="md:w-1/2 p-8 flex flex-col justify-center text-gray-800">
            <h1 className="text-2xl md:text-4xl font-bold mb-4 text-gray-800">Welcome to PharmRx</h1>
