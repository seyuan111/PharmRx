  ...
  return (
    <div className="relative w-full h-screen flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-3xl text-center text-white px-6 md:px-10">
        <h1 className="text-5xl md:text-6xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-teal-300 to-blue-500 animate-fade-in">
          Welcome to PharmRx
        </h1>
        ...
        <p className="mt-2 font-semibold text-teal-300 underline animate-pulse">
        ...
        <div className="mt-8 justify-center flex flex-col sm:flex-row sm:space-x-6 space-y-4 sm:space-y-0">
          <Link
            to="/vaccination"
            className="px-8 py-3 text-lg font-semibold rounded-lg bg-gradient-to-r from-teal-400 to-blue-500 hover:from-teal-500 hover:to-blue-600 transition duration-300 shadow-lg animate-bounce">
