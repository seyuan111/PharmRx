...
const NewsLetter = () => {
  return (
    <div className="w-full py-16 text-white bg-neutral-500 px-4">
        <div className="max-w-[1240px] mx-auto grid lg:grid-col-3">
            ...
            <div className="my-4">
              <div className="flex flex-col sm:flex-row items-center justify-between w-full">
                ...
                <button className="text-white hover:bg-black rounded-md font-medium w-[200px] ml-4 my-6 px-6 py-3">Give Me News</button>
              </div>
